...
export const CONTRACT = {
  ...
  entities: {
    ...
    audit: ['append', 'lastDetail', 'lastByAction', 'countByAction', 'countByFirstToken', 'traceByConversation', 'adminList', 'conversationIdsByActionPrefix', 'archiveBatch', 'archiveStats', 'countByActionPrefix', 'recentByActions', 'timeRange'],
