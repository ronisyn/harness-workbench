...
> 版本：v2.21（2026-09-10 导航定版 + 模型观测 1.0 + Agent 装配向导 + 工具集 UI v2/生命周期 + 技能库共识：§7.2 四组十六页；§7.4 模型观测；§7.5 装配向导+壳日报审批闭环；§7.6 工具集 Tab/开关与生命周期；§7.7 技能库（8 字段模板/软硬双层触发/候选区/三层校验/软停）；仅收录已达成共识，不含讨论过程）
