...
> 版本：v2.21（2026-09-10 导航定版 + 模型观测 1.0 + Agent 装配向导 + 工具集 UI v2/生命周期 + 技能库 + 知识库定位治理：§7.2 四组十六页；§7.4 模型观测；§7.5 装配向导+壳日报审批闭环；§7.6 工具集；§7.7 技能库；§7.8 知识库（学习资料非限制、硬机制单一职责、月度巡检、条目状态/关联字段）；仅收录已达成共识，不含讨论过程）
